...
// Reads a VTK XML ImageData file (.vti). Supports the subset the singn pipeline
// emits: appended raw data, little endian, UInt32 or UInt64 headers, optional
// vtkZLibDataCompressor, identity Direction. Anything else throws
// std::runtime_error naming what was unsupported rather than failing subtly.
